...
anexo3_data = [
    ...
    (
        ...
        "18/01/2026",
        "Factura",
        "FLORES SIANCAS VDA. DE GUEVARA RUTH CONSUELO",
        "E001-449",
        "HOSPEDAJE",
        90.00,
    ),
    ...
    (
        ...
        "18/01/2026",
        "Factura",
        "EMPRESA DE TRANSPORTES PERU BUS SA",
        "F26M-00020463",
        "PASAJE",
        25.00,
    ),
...
comprobantes = [
    ...
    (
        ...
        "HOSPEDAJE",
        "Alojamiento 18/01 al 21/01/2026 - Sr. Julio Mera Casa (4 noches x S/81.82+IGV)",
        327.27,
        0.00,
        0.00,
        0.00,
        ...
        360.00,
        "Contado",
        "MYPE IGV 10%. Anexo3 registra 4 lineas S/90 c/u = S/360",
    ),
    (
        3,
        "18/01/2026",
        ...
        "FF02-00000107",
        "10411107529",
        "RODRIGUEZ AYALA HECTOR (Marlys)",
        "JR. 2 DE MAYO No 392, SAN VICENTE DE CANETE - CANETE - LIMA",
        "ALIMENTACION",
        "1/4 Pollo Brasa S/18 + Gaseosa 1/2 LT S/4.50",
        19.07,
        0.00,
        0.00,
        0.00,
    ...
    (
        ...
        "PASAJE",
        "SERV TRANS RUTA Lima - Canete (Embarque 18/01 16:20)",
        0.00,
        25.00,
        0.00,
        0.00,
        ...
        25.00,
        "Contado",
        "Boleto IDA. Transporte interprovincial exonerado IGV",
    ),
    (
        5,
        "19/01/2026",
        ...
        "ALIMENTACION",
        "Extracto Surtido S/10 + Cafe Combo S/1 + Combo Salchicha S/17",
        25.45,
        0.00,
        0.00,
        0.00,
    ...
    (
        ...
        "E001-5438",
        "10465399669",
        "LOPEZ CAMPOS DAIRY TAHIRI",
        "URB. SANTA ROSA DE HUALCA MZA. C LOTE 19, SAN VICENTE DE CANETE",
        "ALIMENTACION",
        "Chifa Frita + Porcion de Arroz + Gaseosa Personal",
        60.00,
        0.00,
        0.00,
        0.00,
        ...
        60.00,
        "Contado",
        "Sin desglose IGV visible en factura",
    ),
    (
        7,
        "19/01/2026",
        ...
        "FF01-00001284",
        "20604417538",
        "COMPANIA TOVAR E.I.R.L. (ECOMARKET)",
        "JR. 2 DE MAYO NRO 530, SAN VICENTE DE CANETE",
        "ALIMENTACION",
        "Papas nativas S/2 + Leche fresca S/2.50 + Agua san luis S/3 + Inca kola S/2",
        8.05,
        0.00,
        0.00,
        0.00,
    ...
    (
        ...
        "F002-00000394",
        "10421686331",
        "CAM MEJIA JIMMY CESAR (CHIFA KIMFUN)",
        "JR. SAN AGUSTIN NRO 219-A SAN VICENTE - CANETE - LIMA",
        "ALIMENTACION",
        "Taypa Especial S/40 + Sopa Sustancia S/17",
        51.81,
        0.00,
        0.00,
        0.00,
    ...
    (
        ...
        "JR. SEPULVEDA NRO. 231 URB. SAN VICENTE DE CANETE",
        "ALIMENTACION",
        "Combo Tradiciona S/23 + Pina+Melon S/10",
        30.00,
        0.00,
        0.00,
        0.00,
    ...
    (
        ...
        "JR. SAN AGUSTIN NRO 219-A SAN VICENTE - CANETE - LIMA",
        "ALIMENTACION",
        "1/2 Inca Kola S/5 + Sopa Woaming S/18 + Pollo Saltado Hongo Chino S/30",
        48.18,
        0.00,
        0.00,
        0.00,
    ...
    (
        ...
        "F001-881",
        "10515561217",
        "FERNANDEZ PULCHS MANUEL GREGORIO (PIRIS)",
        "JR. SEPULVEDA Nro. 381, SAN VICENTE DE CANETE",
        "ALIMENTACION",
        "Ceviche Pescado S/37 + Inca Kola 600ml S/4",
        37.28,
        0.00,
        0.00,
        0.00,
    ...
    (
        ...
        "JR. SEPULVEDA NRO. 231 URB. SAN VICENTE DE CANETE",
        "ALIMENTACION",
        "Pina+Melon S/10 + Hamburguesa Clasi S/10",
        18.18,
        0.00,
        0.00,
        0.00,
    ...
    (
        ...
        "URB. SANTA ROSA DE HUALCA MZA. C LOTE 19, SAN VICENTE DE CANETE",
        "ALIMENTACION",
        "Causa Rellena + Arroz Chaufa de Mariscos",
        70.00,
        0.00,
        0.00,
        0.00,
    ...
    (
        ...
        "ALIMENTACION",
        "1/4 Pollo Brasa S/17 + Gaseosa Mediana S/3",
        16.95,
        0.00,
        0.00,
        0.00,
    ...
    (
        ...
        "FE01-00001043",
        "20605749381",
        "TAXI RUMI EXPRESS S.A.C.",
        "MZA. F LOTE 01 PROV VISTA ALEGRE IV Q2, CALLAO",
        "MOVILIDAD",
        "Taxi agencia Peru Bus hacia Los Olivos",
        0.00,
        60.00,
        0.00,
        0.00,
    ...
    (
        ...
        "CAR. PANAMERICANA SUR HR. 142.5 VIA LIMA-ICA",
        "PASAJE",
        "SERV TRANS RUTA Canete - Lima (Embarque 21/01 18:01)",
        0.00,
        15.00,
        0.00,
        0.00,
        ...
        15.00,
        "Contado",
        "Boleto RETORNO. Transporte interprovincial exonerado IGV",
    ),
]
...
ws3.cell(
    ...
    "(4 noches). Aqui se registra la factura real unica.",
).font = Font(italic=True, size=9, color="FF0000")

# Totales
total_row3 = nota_row + 1
ws3.merge_cells(f"A{total_row3}:Q{total_row3}")
ws3.cell(row=total_row3, column=1, value="TOTAL COMPROBANTES (16 facturas fisicas)").font = Font(
    bold=True, size=10
)
...
ws3.cell(row=igv_row, column=1, value="RESUMEN DE TASAS IGV DETECTADAS:").font = Font(
    bold=True, size=10
)
...
boletos = [
    (
        ...
        "16:20",
        "LIMA - CANETE",
        "MERA CASAS JULIO IVAN",
        "09620528",
        25.00,
    ),
    (
        2,
        "BOLETO TERRESTRE (RETORNO)",
        "EMPRESA DE TRANSPORTES PERU BUS S.A.",
        "20350227630",
        "F54L-00012299",
        "21/01/2026",
...
ws4.cell(
    row=const_title_row, column=1, value="CONSTANCIAS DE COMISION DE SERVICIO (Anexo 5):"
...
ws4.cell(
    row=sup_row, column=1, value="CONSTANCIA DE COMISION - SUPERVISION Y MONITOREO (Anexo 6):"
).font = Font(bold=True, size=10)
...
ws4.cell(
    ...
    "Firmado por Prof. Fidel Ramos En Borja",
).font = data_font
...
print("  1. Anexo 3 - Rendicion:     19 items, S/924.00 con docs")
print("  2. DJ - Anexo 4:            24 items, S/98.00 sin docs")
print(f"  3. Comprobantes de Pago:    16 facturas fisicas, S/{total_sum:.2f}")
print("  4. Boletos y Boarding Pass: 2 boletos terrestres, S/40.00")
print(f"{'=' * 60}")
