...
resumen_data = [
    (
        ...
        "Factura",
        "F001-1488",
        "SERVICIO DE IMPRESIÓN Y PLOTEO DE PLANOS PARA LA OBTENCIÓN DEL ITSE DE LA SEDE",
        "01",
        19.00,
        "2.3.1.99.1.99",
    ),
    (
        ...
        "Factura",
        "E001-530",
        "SERVICIO DE MONTA CARGA EN VENTANILLA - CARGAR CARPA NUEVA A CAMIÓN 13/01/2026. SERVICIO DE CARGA A LA CASA DE LA LITERATURA - DESCARGA DE CARPA GRANDE",
        "03",
        424.80,
        "2.3.1.99.1.99",
    ),
    (
        ...
        "Recibo Servicios P.",
        "0000-15171",
        "PAGO DE DERECHOS DE CERTIFICADO DE PARÁMETROS URBANÍSTICOS Y EDIFICATORIOS ANTE LA MUNICIPALIDAD DISTRITAL DE ATE",
        "07",
        50.70,
        "2.3.1.99.1.99",
    ),
    (
        ...
        "Declaración Jurada",
        "0000-002",
        "MOVILIDAD LOCAL DÍA 27 DE ENERO 2026, IDA EN UBER ENTRE CONGRESO Y MINEDU",
        "07",
        42.90,
        "2.3.1.99.1.99",
    ),
    (
        ...
        "Factura",
        "F002-8351",
        "COMPRA DE PORTA CHAPA PISO LOPO",
        "01",
        70.00,
        "2.3.1.99.1.99",
    ),
    (
        ...
        "Factura",
        "F001-7369",
        "COMPRA DE 01 TAPACANTO NEGRO, 03 BISAGRA",
        "OT",
        95.00,
        "2.3.1.99.1.99",
    ),
    ...
    (9, "09/02/2026", "Factura", "E001-2892", "UN SELLO 4912", "OT", 36.00, "2.3.1.99.1.99"),
    (
        10,
        "09/02/2026",
        "Factura",
        "FQ01-569",
        "ENVÍO DE PAQUETE (MATERIAL DE OFICINA LIMA - TUMBES)",
        "01",
        55.00,
        "2.3.1.99.1.99",
    ),
    (
        ...
        "Factura",
        "F001-32196",
        "AEROPUERTO, ENROLLADO KAMLU/WANTAN, POLLO CHIJAUKAI, POLLO PIÑA, TALLARÍN DE POLLO. MENÚ DÍA 05/02/2026",
        "OT",
        171.50,
        "2.3.1.99.1.99",
    ),
    (
        ...
        "Factura",
        "FD1-21821",
        "3 POLLOS A LA BRASA, COMPRA DE POLLO DELIVERY DÍA 05/02/2026",
        "07",
        188.50,
        "2.3.1.99.1.99",
    ),
    (
        ...
        "Recibo Servicios P.",
        "0000-260001715589",
        "EMISIÓN DE 127 CERTIFICADOS DIGITALES PARA LA EXPEDICIÓN DE FIRMAS DIGITALES DEL PERSONAL DEL MINEDU",
        "01",
        1028.70,
        "2.3.1.99.1.99",
    ),
    (
        ...
        "Factura",
        "FD15-502949",
        "COMPRA DE REFRIGERIO: 5 GALLETA RITZ, 11 GATORADE, 5 SAN LUIS, 4 FIOARI, 9 GUARANÁ",
        "07",
        158.90,
        "2.3.1.99.1.99",
    ),
    (
        ...
        "Factura",
        "E001-499",
        "SERVICIO DE MONTACARGA EN LA CASA DE LA LITERATURA - CARGA DE CARPA NEUMÁTICA A CAMIÓN. SERVICIO DE MONTACARGA EN VENTANILLA - DESCARGA DE CARPA NEUMÁTICA DE CAMIÓN",
        "03",
        424.80,
        "2.3.1.99.1.99",
    ),
    (
        ...
        "Boleta De Venta",
        "EB01-6",
        "MOVILIDAD PARA LA ENTREGA DE MEDALLAS DEL CONCURSO DE BUENAS PRÁCTICAS DE GESTIÓN EDUCATIVA DE AV. COMERCIO 193 - SAN BORJA A JR. MORRO SOLAR SURCO Y VICEVERSA DÍA 29/01/2026",
        "OT",
        38.00,
        "2.3.1.99.1.99",
    ),
...
comprobantes = [
    ...
    (
        ...
        "Factura Electrónica",
        "F001-1488",
        "ILEGIBLE (parcialmente visible)",
        "CORPORACIÓN IMPRESIONA S.A.C.",
    ...
    (
        ...
        23,
        "27/01/2026",
        "Declaración Jurada / Planilla Movilidad",
        "0000-002",
        None,
        "VARGAS DEL RIO, VERÓNICA GRACE (DNI 41721445)",
    ...
    (
        ...
        "F001-7369",
        "ILEGIBLE",
        "COMERCIAL VICKI E.I.R.L.",
        "Compra de 01 tapacanto negro + 03 bisagras",
        "2 ítems",
        80.51,
        14.49,
        0.00,
        ...
        95.00,
        0.00,
        "Valor venta/IGV estimados desde total S/95.00. Verificar desglose contra factura física.",
    ),
    ...
    (
        ...
        "F001-2192",
        "20606697091",
        "D&D SOLUCIONES ELÉCTRICAS E.I.R.L.",
        "Compra de 04 timbres de 10 pulgadas",
        4,
        213.56,
        38.44,
    ...
    (
        ...
        "E001-2892",
        "10701855406",
        "GSO DIGITAL - SALAZAR ORE GLEM ANDERSON",
        "Compra de 01 sello 4912",
        1,
        30.51,
        5.49,
        0.00,
        ...
        36.00,
        0.00,
        "Factura y resumen coinciden en S/36.00.",
    ),
    ...
    (
        ...
        "F001-00032196",
        "20664646143",
        "HAO YUN LAI LAI S.A.C. (CHIFA WANG XIANG YUAN)",
        "Menús día 05/02/2026: Aeropuerto de pollo, enrollado kamlu/wantan, pollo chijaukai, pollo piña, tallarín de pollo, etc.",
        "10 ítems (8 personas aprox.)",
        145.34,
        26.16,
        0.00,
        171.50,
        ...
        171.50,
        0.00,
        "Gasto de alimentos/coffee break. Valor venta/IGV estimados desde total S/171.50. Desglose exacto parcialmente ilegible en ticket escaneado.",
    ),
    ...
    (
        ...
        "70-71",
        "09/02/2026",
        "Constancia de Pago de Tasas (Banco de la Nación)",
        "NRO TICKET 260001715589",
        "20131370998 (MINEDU)",
        "RENIEC - Emisión de Certificados Digitales",
    ...
    # Gasto 16: EB01-6 - LESCANO HIDALGO MARIO ARTURO
    (
        16,
        "91,112",
        "10/02/2026",
        ...
        38.00,
        0.00,
        "Resumen oficial indica S/38.00. Planilla de movilidad local N° 0003-2026 (pág. 109). Constancia de NO uso de movilidad local adjunta (pág. 111).",
    ),
]
...
obs_list = [
    ...
    "Gastos #11 y #12 (Chifa + Pollos): Alimentos por total S/360.00 en un solo día (05/02/2026). Supera 5% UIT (S/267.50) por evento individual. Verificar si corresponden a eventos separados.",
    ...
    "Gasto #6 (F001-7369): Valor venta/IGV estimados desde total. Verificar desglose contra factura física.",
]
...
ws2[f"A{ref_row}"] = (
    "DIRECTIVA DE REFERENCIA: RJ 0023-2025-MINEDU/SG-OGA - Directiva para la Administración del Fondo de Caja Chica"
)
ws2[f"A{ref_row}"].font = Font(name="Calibri", italic=True, size=8)
ws2.merge_cells(f"A{ref_row}:R{ref_row}")
ws2[f"A{ref_row + 1}"] = (
    "LÍMITES: 10% UIT = S/535.00 (máx. por gasto) | 20% UIT = S/1,070.00 (excepcional con autorización OGA) | 5% UIT = S/267.50 (coffee break/alimentos por evento)"
)
...
print("Total resumen: S/3,090.80")
