...
resumen_data = [
    ...
    (6,  '09/02/2026', 'Factura',             'F001-7369',         'COMPRA DE 01 TAPACANTO NEGRO, 03 BISAGRA', 'OT', 95.00, '2.3.1.99.1.99'),
    ...
    (11, '09/02/2026', 'Factura',             'F001-32196',        'AEROPUERTO, ENROLLADO KAMLU/WANTAN, POLLO CHIJAUKAI, POLLO PIÑA, TALLARÍN DE POLLO. MENÚ DÍA 05/02/2026', 'OT', 171.50, '2.3.1.99.1.99'),
    ...
    (16, '10/02/2026', 'Boleta De Venta',     'EB01-6',            'MOVILIDAD PARA LA ENTREGA DE MEDALLAS DEL CONCURSO DE BUENAS PRÁCTICAS DE GESTIÓN EDUCATIVA DE AV. COMERCIO 193 - SAN BORJA A JR. MORRO SOLAR SURCO Y VICEVERSA DÍA 29/01/2026', 'OT', 38.00, '2.3.1.99.1.99'),
]
...
comprobantes = [
    ...
    (6, 35, '07/02/2026', 'Factura Electrónica', 'F001-7369',
     ...
     '2 ítems', 80.51, 14.49, 0.00, 95.00,
     'Contado', 'SÍ - TESORERÍA', 95.00, 0.00,
    ...
    (9, 51, '06/02/2026', 'Factura Electrónica', 'E001-2892',
     ...
     'Contado', 'SÍ - TESORERÍA 9 FEB 2026', 36.00, 0.00,
    ...
    (11, 63, '05/02/2026', 'Factura Electrónica', 'F001-00032196',
     ...
     '10 ítems (8 personas aprox.)', 145.34, 26.16, 0.00, 171.50,
     'Contado', 'SÍ - TESORERÍA 9 FEB 2026', 171.50, 0.00,
    ...
    (16, '91,112', '10/02/2026', 'Boleta De Venta', 'EB01-6',
     ...
     1, None, None, None, 38.00,
     'Contado', 'SÍ - TESORERÍA 10 FEB 2026', 38.00, 0.00,
