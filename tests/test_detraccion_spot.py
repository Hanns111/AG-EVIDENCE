...
class TestSPOTValidator:
    ...
    def test_match_anexo3_transporte(self, validator):
        ...
        doc = DocumentoAnalizado(
            nombre="orden.pdf",
            texto="Servicio de transporte de materiales educativos",
            paginas=[]
        )
    ...
    def test_sin_observacion_si_tiene_constancia(self, validator):
        ...
        obs_constancia = [o for o in resultado.observaciones if "constancia" in o.descripcion.lower()]
        obs_cuenta = [o for o in resultado.observaciones if "cuenta" in o.descripcion.lower() and "bn" in o.descripcion.lower()]
    ...
    def test_info_monto_supera_umbral(self, validator):
        ...
        doc = DocumentoAnalizado(
            nombre="orden.pdf",
            texto="Servicio de limpieza general",
            paginas=[]
        )
...
class TestFuncionHelper:
    ...
    def test_helper_retorna_tupla(self):
        ...
        doc = DocumentoAnalizado(
            nombre="test.pdf",
            texto="Texto de prueba sin SPOT",
            paginas=[]
        )
